...
const SubHeroSection = () => {
  useEffect(() => {
    AOS.init({ duration: 1000 }); // Initialize AOS without 'once: true'
  }, []);
  ...
  return (
    <div className="flex-col md:flex md:flex-row mt-12">
      {/* Left Text Section */}
      <div
        className="bg-[#c4c4c4] md:w-[50%] flex items-center"
        data-aos="fade-right" // AOS fade-right for this section
      >
        {/* text wrapper */}
        <div className="bg-white my-4 md:my-0 py-4 md:py-8 pr-4 md:pr-12 rounded-r-full">
          <div className="ml-2 md:ml-48">
            ...
            <Link to="/mealplans">
              <button className="flex justify-center items-center gap-2 px-3 py-2 bg-[#6ea963] transition-all hover:bg-[#7be768] hover:scale-105 md:mt-8 mt-4 rounded-lg transform duration-300 ease-in-out">
                Meal Plans <MdOutlineArrowOutward className="inline" />
              </button>
            </Link>
          </div>
      ...
      {/* Right Image Section */}
      <div
        className="bg-yellow-300 m-1 md:m-0 md:w-[50%]"
        data-aos="fade-left" // AOS fade-left for this section
      >
        <img
          src={SubHeroSectionImage}
          alt="sub-image"
