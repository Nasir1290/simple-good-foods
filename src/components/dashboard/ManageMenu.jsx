...
function ManageMenu() {
  ...
  return (
    <div>
      ...
      <table
        data-aos="fade-out"
        className="w-full border-collapse table-auto text-center text-small md:font-bold "
      >
        <thead>
...
//           <option>Large Meal</option>
//         </select>
//         <button className="bg-blue-500 text-white p-2 rounded ml-2 hover:bg-blue-600 transition-colors">
//           + Add Menu
//         </button>
//       </div>
...
//         <tbody>
//           {menuData.map((menu) => (
//             <tr key={menu.id} className="border-t" data-aos="fade-up">
//               <td className="border p-2">{menu.id}</td>
//               <td className="border p-2 text-start">
//                 <img
//                   src={menu.img}
...
//               <td className="border p-2">{menu.mealPlan}</td>
//               <td className="border p-2">
//                 <button className="text-blue-500 bg-gray-300 ml-2 px-3 py-1 text-center rounded-md hover:bg-gray-400 transition-colors">
//                   <FaRegEdit />
//                 </button>
//                 <button className="text-red-500 ml-2 bg-gray-300 px-3 py-1 text-center rounded-md hover:bg-gray-400 transition-colors">
//                   <MdDeleteSweep />
//                 </button>
//               </td>
//             </tr>
